					...
					<div class="block">
						...
						<form role="form" method="POST" action="edit-user.php?id=<?php echo $id; ?>">
							<div class="form-group">
								<label>Email</label>
								<input type="email" value="<?php echo $user->email; ?>" class="form-control" name="title" placeholder="Enter email">
							</div>
								<div class="form-group">
									<label>About</label>
									<textarea id="body" rows="10" cols="80" class="form-control" name="body"><?php echo $user->about; ?></textarea>
